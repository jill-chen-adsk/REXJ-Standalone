...
namespace MappingTable
{
  class ParaSet
  {
    // /// <summary>構造マテリアル
    // /// </summary>
    // private static ForgeTypeId Mate = GroupTypeId.Materials ;
    //
    // /// <summary>文字
    // /// </summary>
    // private const ForgeTypeId Moji = GroupTypeId.Text ;
    //
    // /// <summary>構造
    // /// </summary>
    // private const ForgeTypeId Kouzou = GroupTypeId.Structural ;
    //
    // /// <summary>鉄筋セット
    // /// </summary>
    // private const ForgeTypeId Tekkin = GroupTypeId.RebarArray ;
    //
    // /// <summary>識別情報
    // /// </summary>
    // private const ForgeTypeId Sikibetu = GroupTypeId.IdentityData ;
    ...
    internal static void SetPara_RCClmRe( FamilyManager fmg, FamilyStructure.RC_Clm_Re clm )
    {
      try {
        ...
        SetPara( clm.kind_column, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( clm.kind_column2, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        ...
        SetPara( clm.NameMembers, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
    ...
    internal static void SetPara_SClmH( FamilyManager fmg, FamilyStructure.S_Clm_H clm )
    {
      try {
        ...
        SetPara( clm.name, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( clm.SecId, fmg, SpecTypeId.Int.Integer, GroupTypeId.IdentityData ) ;
        SetPara( clm.type_name, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( clm.type, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( clm.base_type, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;

        //インスタンスパラメータ*********************************************
        SetPara( clm.MemId, fmg, SpecTypeId.Int.Integer, GroupTypeId.IdentityData, true ) ;
        SetPara( clm.NameMembers, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( clm.condition_bottom, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( clm.condition_top, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        ...
        SetPara( clm.kind_joint_top, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( clm.kind_joint_bottom, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
      }
      catch ( Exception ) {
        LogData.AddLog( LogData.LogKind.Error, 3000, clm.FamilyName + " のパラメータ追加に失敗しました。" ) ;
      }
    ...
    internal static void SetPara_SClmBox( FamilyManager fmg, FamilyStructure.S_Clm_Box clm )
    {
      try {
        ...
        //インスタンスパラメータ*********************************************
        SetPara( clm.MemId, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( clm.NameMembers, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( clm.condition_bottom, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( clm.condition_top, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( clm.joint_top, fmg, SpecTypeId.Number, GroupTypeId.IdentityData, true ) ;
    ...
    internal static void SetPara_SClmC( FamilyManager fmg, FamilyStructure.S_Clm_C clm )
    {
      try {
        ...
        SetPara( clm.SecId, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        ...
        SetPara( clm.condition_bottom, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( clm.condition_top, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( clm.joint_top, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( clm.joint_bottom, fmg, SpecTypeId.Number, GroupTypeId.IdentityData, true ) ;
    ...
    internal static void SetPara_SRCClmH( FamilyManager fmg, FamilyStructure.SRC_Clm_H clm )
    {
      try {
        ...
        SetPara( clm.strength_main, fmg, SpecTypeId.Reference.Material, GroupTypeId.Materials ) ;
        SetPara( clm.type, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( clm.typename, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( clm.H, fmg, SpecTypeId.Length, GroupTypeId.Geometry ) ;
        SetPara( clm.B, fmg, SpecTypeId.Length, GroupTypeId.Geometry ) ;
        SetPara( clm.t1, fmg, SpecTypeId.Length, GroupTypeId.Geometry ) ;
        SetPara( clm.t2, fmg, SpecTypeId.Length, GroupTypeId.Geometry ) ;
        SetPara( clm.r, fmg, SpecTypeId.Length, GroupTypeId.Geometry ) ;
        SetPara( clm.direction_type, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
    ...
    internal static void SetPara_SRCClmCross( FamilyManager fmg, FamilyStructure.SRC_Clm_Cross clm )
    {
      try {
        ...
        SetPara( clm.type_X, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( clm.type_Y, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( clm.typename_X, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( clm.typename_Y, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( clm.base_type, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
    ...
    internal static void SetPara_SRCClmT( FamilyManager fmg, FamilyStructure.SRC_Clm_T clm )
    {
      try {
        ...
        SetPara( clm.angle, fmg, SpecTypeId.Length, GroupTypeId.Geometry ) ;
        SetPara( clm.type_H, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( clm.type_T, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( clm.typename_H, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( clm.typename_T, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( clm.base_type, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
    ...
    internal static void SetPara_RCGir( FamilyManager fmg, FamilyStructure.RC_Gir gir )
    {
      try {
        ...
        SetPara( gir.kind_beam, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( gir.kind_beam2, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        ...
        SetPara( gir.NameMembers, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        ...
        SetPara( gir.kind_haunch_start, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( gir.kind_haunch_end, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( gir.type_haunch_H, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( gir.type_haunch_V, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
      }
      catch ( Exception ) {
    ...
    internal static void SetPara_SGirH( FamilyManager fmg, FamilyStructure.S_Gir_H gir )
    {
      try {
        ...
        SetPara( gir.haunch_end, fmg, SpecTypeId.Length, GroupTypeId.Geometry ) ;
        SetPara( gir.SecId, fmg, SpecTypeId.Int.Integer, GroupTypeId.IdentityData ) ;
        SetPara( gir.shape, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( gir.type, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( gir.kind_brace, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;

        //インスタンスパラメータ*********************************************
        SetPara( gir.MemId, fmg, SpecTypeId.Int.Integer, GroupTypeId.IdentityData, true ) ;
        SetPara( gir.NameMembers, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( gir.condition_start, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( gir.condition_end, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( gir.kind_haunch_start, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( gir.kind_haunch_end, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( gir.type_haunch_H, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( gir.type_haunch_V, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        ...
        SetPara( gir.kind_joint_start, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( gir.kind_joint_end, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( gir.future_brace, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
      }
      catch ( Exception ) {
        LogData.AddLog( LogData.LogKind.Error, 3000, gir.FamilyName + " のパラメータ追加に失敗しました。" ) ;
      }
    ...
    internal static void SetPara_SGirC( FamilyManager fmg, FamilyStructure.S_Gir_C gir )
    {
      try {
        ...
        SetPara( gir.shape, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( gir.type, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( gir.side, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( gir.haunch_start, fmg, SpecTypeId.Length, GroupTypeId.Geometry ) ;
        SetPara( gir.haunch_end, fmg, SpecTypeId.Length, GroupTypeId.Geometry ) ;
        SetPara( gir.kind_brace, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
    ...
    internal static void SetPara_SGirL( FamilyManager fmg, FamilyStructure.S_Gir_L gir )
    {
      try {
        ...
        SetPara( gir.kind_beam, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( gir.kind_beam2, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( gir.isOutIn, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( gir.A, fmg, SpecTypeId.Length, GroupTypeId.Geometry ) ;
        SetPara( gir.B, fmg, SpecTypeId.Length, GroupTypeId.Geometry ) ;
        SetPara( gir.t1, fmg, SpecTypeId.Length, GroupTypeId.Geometry ) ;
        SetPara( gir.t2, fmg, SpecTypeId.Length, GroupTypeId.Geometry ) ;
    ...
    internal static void SetPara_SBraH( FamilyManager fmg, FamilyStructure.S_Bra_H bra )
    {
      try {
        ...
        SetPara( bra.shape, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( bra.type, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( bra.kind_brace, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;

        //インスタンスパラメータ*********************************************
        SetPara( bra.MemId, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( bra.NameMembers, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( bra.condition_start, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( bra.condition_end, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( bra.joint_start, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( bra.joint_end, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( bra.kind_joint_start, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( bra.kind_joint_end, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( bra.future_brace, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
      }
      catch ( Exception ) {
    ...
    internal static void SetPara_SBraC( FamilyManager fmg, FamilyStructure.S_Bra_C bra )
    {
      try {
        ...
        SetPara( bra.shape, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( bra.type, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( bra.side, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( bra.kind_brace, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
    ...
    internal static void SetPara_Slab( string Cate, Element el, FamilyStructure.Slab sla )
    {
      ...
      try {
        ...
        SetPara_el( sla.isCanti, el, Cate, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara_el( sla.FigureType, el, Cate, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara_el( sla.product_type, el, Cate, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara_el( sla.product_company, el, Cate, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara_el( sla.product_name, el, Cate, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara_el( sla.product_code, el, Cate, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        ...
        SetPara_el( sla.NameMembers, el, Cate, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        ...
        SetPara_el( sla.dir_load, el, Cate, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        ...
        SetPara_el( sla.type_haunch, el, Cate, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara_el( sla.kind_slab, el, Cate, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara_el( sla.kind_structure, el, Cate, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
    ...
    internal static void SetPara_Wall( string Cate, Element el, FamilyStructure.Wall wal )
    {
      ...
      try {
        ...
        //タイプパラメータ************************************************                
        SetPara_el( wal.name, el, Cate, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        ...
        SetPara_el( wal.kind_form, el, Cate, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        ...
        //インスタンスパラメータ*********************************************
        SetPara_el( wal.kind_structure, el, Cate, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara_el( wal.kind_layout, el, Cate, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara_el( wal.kind_wall, el, Cate, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara_el( wal.type_outside, el, Cate, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara_el( wal.isPress, el, Cate, SpecTypeId.Boolean.YesNo, GroupTypeId.IdentityData, true ) ;
        SetPara_el( wal.MemId, el, Cate, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
    ...
    internal static void SetPara_Foundation_Rect( FamilyManager fmg, FamilyStructure.Foundation_Rect footing )
    {
      try {
        ...
        SetPara( footing.NameMembers, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
    ...
    internal static void SetPara_Foundation_Continuous( FamilyManager fmg, FamilyStructure.Foundation_Continuous footing )
    {
      try {
        ...
        SetPara( footing.type, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
    ...
    internal static void SetPara_Castinpile( FamilyManager fmg, FamilyStructure.Pile pile )
    {
      try {
        ...
        //インスタンスパラメータ*********************************************
        SetPara( pile.kind_structure, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
        SetPara( pile.MemId, fmg, SpecTypeId.Int.Integer, GroupTypeId.IdentityData, true ) ;
        SetPara( pile.NameMembers, fmg, SpecTypeId.String.Text, GroupTypeId.Text, true ) ;
      }
      catch ( Exception ) {
    ...
    internal static void SetPara_Pile( FamilyManager fmg, FamilyStructure.Pile_S pile )
    {
      try {
        //タイプパラメータ************************************************
        SetPara( pile.name, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        //SetPara(pile.id_order, fmg, SpecTypeId.Int.Integer, GroupTypeId.IdentityData);
    ...
    internal static void SetPara_Pile( FamilyManager fmg, FamilyStructure.Pile_PHC pile )
    {
      try {
        ...
        SetPara( pile.name, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        //SetPara(pile.id_order, fmg, SpecTypeId.Int.Integer, GroupTypeId.IdentityData);
        SetPara( pile.kind, fmg, SpecTypeId.String.Text, GroupTypeId.Text ) ;
        SetPara( pile.length_pile, fmg, SpecTypeId.Length, GroupTypeId.Geometry ) ;
        SetPara( pile.D, fmg, SpecTypeId.Length, GroupTypeId.Geometry ) ;
        SetPara( pile.t, fmg, SpecTypeId.Length, GroupTypeId.Geometry ) ;
        SetPara( pile.strength_concrete, fmg, SpecTypeId.Reference.Material, GroupTypeId.Materials ) ;
    ...
    internal static bool SetPara( string st, FamilyManager fmg, ForgeTypeId type, ForgeTypeId group, bool flg = false, bool setdef = false, object defval = null )
    {
      ...
      DefinitionGroup g = defGroups.get_Item( Commons.groupName ) ;
      ...
      if ( fmg.get_Parameter( st ) == null ) {
        ...
        if ( setdef && defval != null ) {
          ...
          if ( p != null ) {
            //必要になったら随時追加
            var typeid = p.Definition.GetDataType() ;
            if ( typeid == SpecTypeId.Boolean.YesNo ) {
