...
namespace CmdDuctDisplacement.UI.Commands.DuctConnection
{
    ...
    class IncreaseCommand : ICommand
    {
        ...
        //コンストラクタ
        #region Constructor
        public IncreaseCommand(ConnectionSettingViewModel ductPropaty, Logger _log)
        {
            ductp = ductPropaty;
            log = _log;
        }
...
#pragma warning restore 0067
        ...
        public void Execute(object parameter)
        {
            ...
            controlstatus.CallRoute = DuctDisplacementDefine.TextChangeRoute.IncreaseButton;
            ductp.DuctOffsetLevel = cal.AddValueToOriginarValue(ductp, DuctDisplacementDefine.MethodOfCalculation.Add).ToString();
        }
        #endregion
    }
}
