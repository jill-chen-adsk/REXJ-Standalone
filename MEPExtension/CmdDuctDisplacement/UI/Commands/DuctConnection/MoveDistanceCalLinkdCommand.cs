...
namespace CmdDuctDisplacement.UI.Commands.DuctConnection
{
    ...
    /// </summary>
    class MoveDistanceCalLinkdCommand : ICommand
    {
        //メンバ変数
        ...
        //コンストラクタ
        #region Constructor
        public MoveDistanceCalLinkdCommand(ConnectionSettingViewModel ductPropaty, Logger _log)
        {
            ductp = ductPropaty;
            log = _log;
        }
...
#pragma warning restore 0067
        ...
        public void Execute(object parameter)
        {
            ...
            ductp.EndWork(DuctDisplacementDefine.WindowReturnNum.GraphicInstructions_Linkd);
        }
        #endregion
    }
}
