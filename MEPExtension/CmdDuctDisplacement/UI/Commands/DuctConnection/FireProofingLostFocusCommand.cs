...
{
    /// <summary>
    /// 耐火被覆厚(梁)テキストボックスLostFocusイベント関連クラス
    /// </summary>
    class FireProofingLostFocusCommand : TextBoxLostFocusBase
    {
        //メンバ変数
        ...
        //コンストラクタ
        #region Constructor
        public FireProofingLostFocusCommand(ConnectionSettingViewModel ductPropaty, Logger _log, ConnectionSettingView _uiwindow)
        {
            ductp = ductPropaty;
            log = _log;
            textbox = _uiwindow.FireTextBox;
        }
        #endregion
