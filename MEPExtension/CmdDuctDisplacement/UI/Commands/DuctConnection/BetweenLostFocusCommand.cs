...
{
    /// <summary>
    /// 部材間距離テキストボックスのLostFocusイベント関連のクラス
    /// </summary>
    class BetweenLostFocusCommand : TextBoxLostFocusBase
    {
        //メンバ変数
        ...
        //コンストラクタ
        #region Constructor
        public BetweenLostFocusCommand(ConnectionSettingViewModel ductPropaty, Logger _log, ConnectionSettingView _uiwindow)
        {
            ductp = ductPropaty;
            log = _log;
            textbox = _uiwindow.BetweenTextBox;
        }
        #endregion
