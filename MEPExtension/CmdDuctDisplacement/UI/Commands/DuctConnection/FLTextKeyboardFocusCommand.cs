...
{
    /// <summary>
    /// FMテキストボックスのGotKeyboardFocusイベント関連クラス
    /// </summary>
    class FLTextKeyboardFocusCommand : ICommand
    {
        //メンバ変数
        ...
        //コンストラクタ
        #region Constructor
        public FLTextKeyboardFocusCommand(ConnectionSettingViewModel ductPropaty, Logger _log)
        {
            ductp = ductPropaty;
            log = _log;
        }
...
#pragma warning restore 0067
        ...
        public void Execute(object parameter)
        {
            ...
            //テキストボックスにフォーカスが移ったときにテキストボックスの書き換え経路をセットする
            controlstatus.CallRoute = DuctDisplacementDefine.TextChangeRoute.Text;
        }
        #endregion
    }
}
