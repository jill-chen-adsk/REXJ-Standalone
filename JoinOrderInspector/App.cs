...
namespace ADSK.JExtRAC.JoinOrderInspector
{
    public class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            var pulldown = FindPulldown(panel, "JoinPulldown");
            if (pulldown == null)
            {
                var pulldownData = new PulldownButtonData("JoinPulldown", "Join");
                pulldownData.LargeImage = LoadPng("IDI_BTN_JOIN_ORDER_L.png", 32);
                pulldownData.Image = LoadPng("IDI_BTN_JOIN_ORDER_S.png", 16);
            ...
            var btnData = new PushButtonData(
                ...
                assemblyPath,
                "ADSK.JExtRAC.JoinOrderInspector.Commands.CmdJoinOrderInspect");
            btnData.LargeImage = LoadPng("IDI_BTN_JOIN_ORDER_L.png", 32);
            btnData.Image = LoadPng("IDI_BTN_JOIN_ORDER_S.png", 16);
