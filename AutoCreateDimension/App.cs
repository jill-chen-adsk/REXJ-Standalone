...
using ADSK.JExtRAC.AutoCreateDimension.Utils;

namespace ADSK.JExtRAC.AutoCreateDimension
{
    public class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            var btnData = new PushButtonData(
                "cmdBatchObjectDimension",
                "Batch Object Dimension",
                assemblyPath,
                "ADSK.JExtRAC.AutoCreateDimension.Commands.CmdAutoCreateDimension");
            btnData.LargeImage = LoadPng("IDI_BTN_AUTOCREATEDIMENSION_L.png", 32);
            btnData.Image = LoadPng("IDI_BTN_AUTOCREATEDIMENSION_S.png", 16);
