...
namespace SectionListRC.BeamList
{
    ...
    public class CmdBeamImage : Revit.UI.IExternalCommand
    {
        // メンバ関数
                                       ...
                                       Revit.DB.ElementSet elements)
        {
            ...
            // スタート
            transGroup.Start(cmpAttribute.ResourceText("IDS_BTN_BEAMLISTIMAGE_NAME"));
            ...
            {
                System.Windows.Forms.MessageBox.Show(cmpAttribute.ResourceText("IDS_ERR_NOTARGETGIRDER"));
                transGroup.Assimilate();
                return retCmd;
            }
            ...
            //Show form
            FormBeamOption form = new FormBeamOption(cmpAttribute, true, settings, 2);
            ...
            if (form.IsExportAllChecked == false)
            {
                ...
                //Show form
                var formList = new FormBeamItemList(cmpAttribute, cmpParameters, settings, enumType, enHugoAry_filter.ToList(), data, allColumnLevelAry_filter.ToList(), 2);
            ...
            string msg = cmpElements.SetCreateListView(viewScale, ref current);
            ...
            try
            {
                foreach (Collections.Generic.IList<Revit.DB.FamilySymbol> bAry in aryAry)
                {
                    ...
                    l = cmpElements.CreateBoundLine(new Revit.DB.XYZ(kaiHidariUe.X, kaiHidariUe.Y + h_Hugowaku + h_Ichiwaku, kaiHidariUe.Z), kaiHidariUe + new Revit.DB.XYZ(0, 0, 0));
                    cmpElements.NotNullCurveSet(ref crvFrameAry, l);
                    ...
                    if (kaihyoji == true)
                    {
                        ...
                        txtNote = cmpService.CreateNewTextNote(viewWork, origin, baseVec, lineWidth, otherTNT.Id, str, rvtDbDoc);
                                        ...
                                        rectangleCrvs.Count == 4)
                                    {
                                        ...
                                        if (rebarShow == 1)
                                        {
                                            ...
                                            if (isSyukinUeSet > 0)
                                            {
                                                ...
                                                txtNote = cmpService.CreateNewTextNote_RebarSyukinOffset(viewWork, txtNoteOrigin, baseVec, lineWidth, otherTNT.Id, title, rvtDbDoc);
                                            ...
                                            if (isSyukinSitaSet > 0)
                                            {
                                                ...
                                                txtNote = cmpService.CreateNewTextNote_RebarSyukinOffset(viewWork, innerBottom, baseVec, lineWidth, otherTNT.Id, title, rvtDbDoc);
                                            ...
                                            rectangleCrvs1.Count == 4)
                                        {
                                            ...
                                            if (rebarShow == 1)
                                            {
                                                ...
                                                if (isSyukinUeSet > 0)
                                                {
                                                    ...
                                                    txtNote = cmpService.CreateNewTextNote_RebarSyukinOffset(viewWork, innerTop, baseVec, lineWidth, otherTNT.Id, title, rvtDbDoc);
            ...
            if (isExported)
            {
                System.Windows.Forms.MessageBox.Show(cmpAttribute.ResourceText("IDS_TXT_IMAGESET_BEAM"));
            }
