...
{
  /// ================================================================================
  /// <summary>共有パラメータ - 角柱</summary>
  /// ================================================================================
  public class SpKakuColumn : SectionListRC.Entities.SpBase
  {
    // メンバ変数
    #region
    ...
    #region Constructor
      ...
      /// ================================================================================
      public SpKakuColumn(SectionListRC.Components.Attribute cmpAttribute,
             ...
             base(cmpAttribute, cmpParameters, cmpSettings)
      {
        ...
        // パラメータカテゴリ
        _ParamCategories = base.CmpSettings.CategoryColumn;
