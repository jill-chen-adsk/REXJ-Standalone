...
namespace SectionListRC.Entities
{
  ...
  public abstract class SpBase
  {
    ...
    #region Constructor
      ...
      /// ================================================================================
      protected SpBase(SectionListRC.Components.Attribute cmpAttribute, 
    ...
    #region Member Functions
      ...
      {
        Collections.Generic.IList<string> defCatNames = SectionListRC.JExtComCompat.UtilValue.SplitString(_DefCatName, ",");
