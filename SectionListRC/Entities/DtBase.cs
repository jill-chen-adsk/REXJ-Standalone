...
namespace SectionListRC.Entities
{
  ...
  public abstract class DtBase
  {
    ...
    #region Constructor
      ...
      /// ================================================================================
      protected DtBase(SectionListRC.Components.Attribute cmpAttribute,
    ...
    #region Member Functions
      ...
      /// <param name="dataAry">コマンドデータ</param>
      /// 
      /// <history>2012/08/13 Created GSA,Inc. Ryo Kuroda</history>
      /// ================================================================================
      protected 
    ...
    #region Properties
      ...
      /// ================================================================================
      protected
      SectionListRC.Components.Attribute CmpAttribute
      {
        get
        {
      ...
      /// <history>2013/07/10 Created GSA,Inc. Ryo Kuroda</history>
      /// ================================================================================
      public string LevelSortOrdeer
      {
        get
        {
