...
namespace SectionListRC.Setting
{
    ...
    public class CmdBeamListSetting : Revit.UI.IExternalCommand
    {
        // メンバ関数
                                       ...
                                       Revit.DB.ElementSet elements)
        {
            ...
            // スタート
            transGroup.Start(cmpAttribute.ResourceText("IDS_BTN_BEAMLISTSETTING_NAME"));
            ...
            System.Windows.Forms.DialogResult dlgRet = formBeamSetting1.ShowDialog();

            int formRet = formBeamSetting1.BeamListSettingResult1;
