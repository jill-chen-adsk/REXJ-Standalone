...
namespace SectionListRC.Setting
{
    ...
    public class CmdSetting : Revit.UI.IExternalCommand
    {
        // メンバ関数
                                       ...
                                       Revit.DB.ElementSet elements)
        {
            ...
            // スタート
            transGroup.Start(cmpAttribute.ResourceText("IDS_BTN_SETTINGFILE_NAME"));
            ...
            System.Windows.Forms.DialogResult dlgRet = formSetting.ShowDialog();

            int formRet = formSetting.SettingResult;
            ...
            {
                retCmd = Revit.UI.Result.Cancelled;
                transGroup.Assimilate();
                return retCmd;
            }
