...
namespace SectionListRC.ColumnList
{
    ...
    public class CmdEachOneColumnList : Revit.UI.IExternalCommand
    {
        // メンバ関数
                                       ...
                                       Revit.DB.ElementSet elements)
        {
            ...
            // スタート
            transGroup.Start(cmpAttribute.ResourceText("IDS_BTN_EACHONECOLUMNLIST_NAME"));
            ...
            {
                //Show form
                FormColumnOption form = new FormColumnOption(cmpAttribute, true, settings, 1);
            ...
            if (isAll == false)
            {
                ...
                FormColumnItemList formList = new FormColumnItemList(cmpAttribute, cmpParameters, settings, mode == 0 ? EnumType.Column : EnumType.Post, columnHugoAry_filter.ToList(),
                    enHugoAry_filter.ToList(), kakuData, enData, allColumnLevelAry_filter.ToList(),1);
            ...
            cmpElements.SetCreateListView(listViewScale);
            ...
            // string exportFolder = exportFolderPath + "\\" + projName + "\\柱";
            ...
            // exportFolder = exportFolderPath + "\\" + projName + "\\間柱";
            ...
            foreach (Collections.Generic.IList<Revit.DB.FamilySymbol> cAry in aryAry)
            {
                ...
                if (bunrui == cmpAttribute.ResourceText("IDS_TXT_COLUMN"))
                {
                    ...
                    //exportFolder = exportFolderPath + "\\" + projName + "\\柱";
                }
                ...
                // 柱の分別
                //cmpElements.ColumnDivision(cAry, dX, dY, tyokkei, ref kakuColumnAry, ref enColumnAry);
                cmpService.ColumnDivision(cAry, ref kakuColumnAry, ref enColumnAry);
                ...
                // 全階 = 行数
                Collections.Generic.IList<string> allColumnLevelAry = cmpService.GetAllColumnLevelAry(cAry);
                ...
                l = cmpElements.CreateBoundLine(new Revit.DB.XYZ(kaiHidariUe.X, kaiHidariUe.Y + h_Hugowaku, kaiHidariUe.Z), kaiHidariUe + new Revit.DB.XYZ(0, 0.01, 0));
                cmpElements.NotNullCurveSet(ref crvAryFrame, l);
