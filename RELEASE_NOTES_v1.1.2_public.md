...
|---|-----------|----------|-------------|---------|--------------|
| **09** | [**Download**](https://github.com/jill-chen-adsk/REXJ-Standalone/releases/download/v1.1.2/REXJ_09_LegalComplianceCheck_Setup_1.1.2.exe) | **Legal compliance check (Weave-Compliant)** | **Weave WPF dialogs for Daylight, Smoke, and Ventilation Check with unit fixes** | **1.1.2** | **2026-07-13** |
