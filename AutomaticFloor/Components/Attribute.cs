...
namespace ADSK.JExtRAC.AutomaticFloor.Components
{
    public class Attribute
    {
        ...
        public Attribute()
        {
            ...
            _resourceManText = new ResourceManager("ADSK.JExtRAC.AutomaticFloor.Resources.Text", assembly);
            _resourceManImage = new ResourceManager("ADSK.JExtRAC.AutomaticFloor.Resources.Image", assembly);
        }
