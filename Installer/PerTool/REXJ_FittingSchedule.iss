; REXJ Standalone - Window Door Views Installer for Revit 2027
; Built with Inno Setup 6
; Weave-compliant: Dark/light theme support, globalized UI (JA/EN)

#define MyAppName "REXJ - Window Door Views (Weave)"
...
[Setup]
AppId={{A1000018-E5F6-7890-ABCD-EF1234567890}
AppName={#MyAppName}
...
OutputBaseFilename=REXJ_FittingSchedule_Setup_{#MyAppVersion}
...
[Files]
Source: "{#SrcReleased}\FittingSchedule\*"; DestDir: "{app}\ADSK.JExtRAC.FittingSchedule"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "{#SrcReleased}\FittingSchedule\ADSK.JExtRAC.FittingSchedule.addin"; DestDir: "{app}"; Flags: ignoreversion
