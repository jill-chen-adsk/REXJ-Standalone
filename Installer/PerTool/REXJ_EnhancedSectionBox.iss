; REXJ Standalone - Enhanced Section Box Installer for Revit 2027
; Built with Inno Setup 6
; Weave-compliant: Dark/light theme support, WPF dialogs for Box View and Section Box Adjustment

#define MyAppName "REXJ - Enhanced Section Box (Weave)"
...
[Setup]
AppId={{A1000012-E5F6-7890-ABCD-EF1234567890}
AppName={#MyAppName}
...
OutputDir=..\Output\PerTool
OutputBaseFilename=REXJ_EnhancedSectionBox_Setup_{#MyAppVersion}
...
[Files]
Source: "..\..\EnhancedSectionBox\Released\*"; DestDir: "{app}\ADSK.JExtRAC.EnhancedSectionBox"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\..\EnhancedSectionBox\Released\ADSK.JExtRAC.EnhancedSectionBox.addin"; DestDir: "{app}"; Flags: ignoreversion
