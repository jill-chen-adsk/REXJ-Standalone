; REXJ Standalone - Level Filter Installer for Revit 2027
; Built with Inno Setup 6
; Weave-compliant: Dark/light theme support, WPF DataGrid with single-click checkboxes

#define MyAppName "REXJ - Level Filter (Weave)"
...
[Setup]
AppId={{A100000A-E5F6-7890-ABCD-EF1234567890}
AppName={#MyAppName}
...
OutputBaseFilename=REXJ_LevelFilter_Setup_{#MyAppVersion}
...
[Files]
Source: "..\..\LevelFilter\Released\*"; DestDir: "{app}\ADSK.JExtRAC.LevelFilter"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\..\LevelFilter\Released\1_ADSK.JExtRAC.LevelFilter.addin"; DestDir: "{app}"; Flags: ignoreversion
