; REXJ Standalone - Multi Query Filter Installer for Revit 2027
; Built with Inno Setup 6
; Weave-compliant: Level Filter dialog with dark/light theme, WPF DataGrid

#define MyAppName "REXJ - Multi Query Filter (Weave)"
...
[Setup]
AppId={{B100001F-E5F6-7890-ABCD-EF1234567890}
AppName={#MyAppName}
...
OutputBaseFilename=REXJ_37_MultiQueryFilter_Setup_{#MyAppVersion}
