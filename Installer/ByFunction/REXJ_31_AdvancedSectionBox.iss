; REXJ Standalone - Advanced Section Box Installer for Revit 2027
; Built with Inno Setup 6
; Weave-compliant: Dark/light theme support, WPF dialogs for Box View and Section Box Adjustment

#define MyAppName "REXJ - Advanced Section Box (Weave)"
...
[Setup]
AppId={{B1000019-E5F6-7890-ABCD-EF1234567890}
AppName={#MyAppName}
...
OutputBaseFilename=REXJ_31_AdvancedSectionBox_Setup_{#MyAppVersion}
