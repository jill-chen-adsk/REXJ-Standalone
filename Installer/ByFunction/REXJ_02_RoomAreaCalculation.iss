...
#define MyAppName "REXJ - Room Area Calculation for Building Application"
...
[Setup]
AppId={{B1000002-E5F6-7890-ABCD-EF1234567890}
AppName={#MyAppName}
...
OutputBaseFilename=REXJ_02_RoomAreaCalculation_Setup_{#MyAppVersion}
...
[Files]
Source: "{#SrcReleased}\AreaSchedule\*"; DestDir: "{app}\ADSK.JExtRAC.AreaSchedule"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "{#SrcReleased}\AreaSchedule\1_ADSK.JExtRAC.AreaSchedule.addin"; DestDir: "{app}"; Flags: ignoreversion
