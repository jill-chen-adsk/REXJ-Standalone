...
namespace Quantity.Entities
{
  ...
  public class DtCmd :  DtBase
  {
    ...
    private Quantity.Entities.SpCmd _EntSpCmd;
    ...
    /// 
    /// <history><p>2017/07/19 Created GSA,Inc. Ryo Kuroda</p></history>
    /// ================================================================================
    public DtCmd(Quantity.Components.Attribute cmpAttribute,
    ...
    {
      _EntSpCmd = new Quantity.Entities.SpCmd(cmpAttribute,
                                               cmpParameters,
                                               cmpSettings,
                                               projInfo,
                                               defName,
      ...
      if (_EntSpCmd.DefSuccess == false)
      {
        ...
        if (cmpParameters.SetSharedParamDefault() == false)
        {
          ...
          string fileName = "GSAI_ExtRST_SectionList.txt";
