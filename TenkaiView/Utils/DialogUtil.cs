    ...
    public static class DialogUtil
    {
        ...
        public static int SetLastValue(ComboBox comboBoxControl, string dialogBoxName, string defaultValue = "", bool onlyGetValue = false)
        {
            ...
            if (comboBoxControl.DropDownStyle == ComboBoxStyle.DropDownList)
            {
                ...
                else if (double.TryParse(strLast, out _))
                {
        ...
        {
            string strLast = RegistryHelper.GetSetting(AppName, dialogBoxName, numericUpDnControl.Name, defaultValue.ToString());
            decimal intLast = 0;
            if (decimal.TryParse(strLast, out decimal parsed))
                intLast = parsed;
        ...
        public static void SaveLastValue(NumericUpDown numericUpDnControl, string dialogBoxName) =>
            RegistryHelper.SaveSetting(AppName, dialogBoxName, numericUpDnControl.Name, numericUpDnControl.Value.ToString());
