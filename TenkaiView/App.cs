...
namespace ADSK.ViewExtension.TenkaiView
{
    public class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            var btnData = new PushButtonData(
                "CmdTenkaiView",
                "Interior Elevation for Room",
                assemblyPath,
                "ADSK.ViewExtension.TenkaiView.Commands.CmdTenkaiView");
            btnData.LargeImage = LoadPng("IDI_BTN_TENKAIVIEW_L.png", 32);
            btnData.Image = LoadPng("IDI_BTN_TENKAIVIEW_S.png", 16);
