...
namespace ADSK.JExtRAC.ExportExcel
{
    public class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            var btnExport = new PushButtonData(
                ...
                "Export Excel",
                assemblyPath,
                "ADSK.JExtRAC.ExportExcel.Commands.CmdExportExcel");
            btnExport.LargeImage = LoadPng("IDI_BTN_EXPORT_EXCEL_L.png", 32);
            btnExport.Image = LoadPng("IDI_BTN_EXPORT_EXCEL_S.png", 16);
