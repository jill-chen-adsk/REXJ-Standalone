...
namespace ADSK.JExtRAC.GridDimension
{
    public class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            var btnData = new PushButtonData(
                ...
                "Grid Dimension",
                assemblyPath,
                "ADSK.JExtRAC.GridDimension.Commands.CmdGridDimension");
            btnData.LargeImage = LoadPng("IDI_BTN_GRIDDIMENSION_CONFIG_L.png", 32);
            btnData.Image = LoadPng("IDI_BTN_GRIDDIMENSION_CONFIG_S.png", 16);
