...
namespace ADSK.JExtRAC.LocateSlab.Components
{
    public class Parameters
    {
        ...
        public bool SetValue(Element elem, BuiltInParameter bip, double value)
        {
            try
            {
                var param = elem.get_Parameter(bip);
        ...
        public bool SetValue(Element elem, string paramName, ForgeTypeId paramType,
        ...
        public Category CategoryProjInfo =>
            Category.GetCategory(RvtDBDoc, BuiltInCategory.OST_ProjectInformation);
    }
}
