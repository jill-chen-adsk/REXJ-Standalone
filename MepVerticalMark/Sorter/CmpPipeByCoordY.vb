...
Public Class CmpPipeByCoordY
    Implements System.Collections.Generic.IComparer(Of DB.Plumbing.Pipe)

    Public Function Compare(x As Pipe, y As Pipe) As Integer Implements IComparer(Of Pipe).Compare
        'Nothingが最も小さいとする
