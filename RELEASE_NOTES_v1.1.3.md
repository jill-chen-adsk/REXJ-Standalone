...
- No changes in v1.1.3 — see [v1.1.2](https://git.autodesk.com/chenji/REXJ-Standalone/releases/tag/v1.1.2) for Weave WPF dialogs and smoke unit fixes
...
|------|-------------|---------|--------------|
| [REXJ_Standalone_Setup_1.1.3.exe](https://git.autodesk.com/chenji/REXJ-Standalone/releases/download/v1.1.3/REXJ_Standalone_Setup_1.1.3.exe) | Complete bundle: choose components and install every REXJ Standalone tool for Revit 2027 | **1.1.3** | **2026-08-31** |
...
| **01** | [**Full bundle**](https://git.autodesk.com/chenji/REXJ-Standalone/releases/download/v1.1.3/REXJ_Standalone_Setup_1.1.3.exe) | **🌐 Avg Site Level Calculation (Weave-Compliant)** | **Dark/light theme WPF dialogs — available in the full bundle only, no per-function installer yet** | **1.1.3** | **2026-08-31** |
...
| **34** | [**Full bundle**](https://git.autodesk.com/chenji/REXJ-Standalone/releases/download/v1.1.3/REXJ_Standalone_Setup_1.1.3.exe) | **🌐 Print Region / Range Print (Weave-Compliant)** | **Dark/light theme WPF dialog, metric and imperial scale presets, plan-view region crop fix** | **1.1.3** | **2026-08-31** |
...
| [**Full bundle**](https://git.autodesk.com/chenji/REXJ-Standalone/releases/download/v1.1.3/REXJ_Standalone_Setup_1.1.3.exe) | **🌐 Fitting Schedule / Window Door View (Weave-Compliant)** | **First working build of the Weave Create View dialog — available in the full bundle only** | **1.1.3** | **2026-08-31** |
