...
namespace ADSK.JExtRAC.AveSiteLevelHeightCalc.Components
{
    public class Attribute
    {
        ...
        public Attribute()
        {
            ...
            _textResourceManager = new ResourceManager("ADSK.JExtRAC.AveSiteLevelHeightCalc.Resources.Text", asm);
            _imageResourceManager = new ResourceManager("ADSK.JExtRAC.AveSiteLevelHeightCalc.Resources.Image", asm);
            ...
            try
            {
                ...
                _enTextResourceManager = new ResourceManager(
                    "ADSK.JExtRAC.AveSiteLevelHeightCalc.Resources.Text.en",
                    satAsm);
            }
            catch
            {
