...
namespace SectionListSteel.Setting
{
    ...
    public class CmdColumnSetting : Revit.UI.IExternalCommand
    {
        // メンバ関数
                                       ...
                                       Revit.DB.ElementSet elemenets)
        {
            ...
            transacGrp.Start(cmpAttribute.ResourceText("IDS_BTN_COLUMNSETTING_NAME"));
            ...
            //System.Windows.Forms.DialogResult dlgRlt = formColumnSetting.ShowDialog();

            //int formRet = formColumnSetting.SettingResult;
