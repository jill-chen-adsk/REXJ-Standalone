...
namespace SectionListSteel.Entities
{
  ...
  public class DtCmd : DtBase
  {
    ...
    private SectionListSteel.Entities.SpCmd _EntSpCmd;
    ...
    /// ================================================================================
    public DtCmd(SectionListSteel.Components.Attribute cmpAttribute,
           ...
           base(cmpAttribute, cmpElements, cmpGeometry, cmpParameters, cmpSettings)
    {
      ...
      _EntSpCmd = new SectionListSteel.Entities.SpCmd(cmpAttribute,
                                               cmpParameters,
                                               cmpSettings,
                                               projInfo,
                                               defName,
