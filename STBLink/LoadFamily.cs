...
namespace STBLink
{
    class LoadFamily
    {
        ...
        internal  bool LoadFfamily_fromProject()
        {
            bool ret = true;
                    ...
                    foreach (Element el in elements)
                    {
                        ...
                        if (familySymbol != null)
                        {
                            ...
                            if (addflg)
                            {
                                ...
                                fam.FamilyTypeName = familySymbol.Name;
                        ...
                        {
                            ProjectFamily fam = new ProjectFamily();
                            fam.FamilyName = el.Name;
                            fam.FamilyTypeName = el.Name;
                            FamilyNameList.Add(fam);
                        }
        ...
        internal  bool LoadLevelfamily_fromProject()
        {
            ...
            else
            {
                ...
                foreach (Element el in LVlist)
                {
                    ...
                    lvst.id = lv.Id;
                    lvst.name = lv.Name;
                    lvst.elevation = Math.Round(Commons.ft2mm(lv.Elevation, 3), 3);
