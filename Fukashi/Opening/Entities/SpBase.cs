...
namespace ADSK.Ext.Fukashi.Opening.Entities
{
  ...
  public abstract class SpBase
  {
    ...
    /// <remarks>Standalone replacement for JExtCom.Dnf.UtilValue.SplitString behavior.</remarks>
    ...
    {
      Collections.Generic.IList<string> defCatNames = SplitDelimitedStrings(_DefCatName, ",");
