...
namespace ADSK.Ext.Fukashi.Face.Entities
{
  ...
  public class DtCmd : DtBase
  {
    ...
    private RvtExtApp.Face.Entities.SpCmd _EntSpCmd;
    ...
    /// ================================================================================
    public DtCmd(RvtExtApp.Face.Components.Attribute cmpAttribute,
    ...
    {
      _EntSpCmd = new RvtExtApp.Face.Entities.SpCmd(cmpAttribute,
                                               cmpParameters,
                                               cmpSettings,
                                               projInfo,
                                               defName,
