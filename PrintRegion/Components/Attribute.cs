...
namespace ADSK.JExtRAC.PrintRegion.Components
{
    public class Attribute
    {
        ...
        public Attribute()
        {
            ...
            _textResourceManager = new ResourceManager("ADSK.JExtRAC.PrintRegion.Resources.Text", asm);
            _imageResourceManager = new ResourceManager("ADSK.JExtRAC.PrintRegion.Resources.Image", asm);
        }
