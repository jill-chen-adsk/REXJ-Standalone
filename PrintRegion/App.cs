    ...
    public class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            var btnData = new PushButtonData(
                ...
                "Range\nPrint",
                assemblyPath,
                "ADSK.JExtRAC.PrintRegion.Commands.CmdPrint");
            btnData.LargeImage = LoadPng("IDI_BTN_PRINT_REGION_L.png", 32);
            btnData.Image = LoadPng("IDI_BTN_PRINT_REGION_S.png", 16);
