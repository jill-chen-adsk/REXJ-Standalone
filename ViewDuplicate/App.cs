...
using ADSK.ViewExtension.ViewDuplicate.Utils;

namespace ADSK.ViewExtension.ViewDuplicate
{
    public class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            var pulldown = FindPulldown(panel, "ViewsPulldown");
            if (pulldown == null)
            {
                var pulldownData = new PulldownButtonData("ViewsPulldown", "Views");
                pulldownData.LargeImage = LoadPng("IDI_BTN_VIEWDUPLICATE_L.png", 32);
                pulldownData.Image = LoadPng("IDI_BTN_VIEWDUPLICATE_S.png", 16);
            ...
            var btnData = new PushButtonData(
                ...
                "View Copy",
                assemblyPath,
                "ADSK.ViewExtension.ViewDuplicate.Commands.CmdViewDuplicate");
            btnData.LargeImage = LoadPng("IDI_BTN_VIEWDUPLICATE_L.png", 32);
            btnData.Image = LoadPng("IDI_BTN_VIEWDUPLICATE_S.png", 16);
            btnData.ToolTip = Resources.Text.CMD_VIEWDUPLICATE;
