...
namespace ADSK.JExtRAC.CheckingALVS.SmokeExhaustion
{
    /// ================================================================================
    /// <summary>コマンド 排煙チェック</summary>
    /// ================================================================================
    ...
    public class CmdSmokeExhaustion : Revit.UI.IExternalCommand
    {
        // メンバ関数
                                ...
                                Revit.DB.ElementSet elements)
        {
            ...
            try
            {
                ...
                RvtExtApp.Components.Service cmpService = new RvtExtApp.Components.Service(cmpAttribute,
                                                                                           ...
                                                                                           cmpParameters,
                                                                                           cmpSettings);
                string retMsg = cmpService.WorkFlow(1);
                if (retMsg != null)
                {
