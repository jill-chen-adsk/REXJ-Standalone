...
namespace ADSK.JExtRAC.CheckingALVS.AirVentilation
{
    /// ================================================================================
    /// <summary>コマンド 換気チェック</summary>
    /// ================================================================================
    ...
    public class CmdAirVentilation : Revit.UI.IExternalCommand
    {
        // メンバ関数
                                ...
                                Revit.DB.ElementSet elements)
        {
            ...
            try
            {
                ...
                RvtExtApp.Components.Service cmpService = new RvtExtApp.Components.Service(cmpAttribute,
                                                                                           ...
                                                                                           cmpParameters,
                                                                                           cmpSettings);
                string retMsg = cmpService.WorkFlow(2);
                if (retMsg != null)
                {
