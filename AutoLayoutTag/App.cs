...
namespace ADSK.JExtRAC.AutoLayoutTag
{
    public class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            var btnData = new PushButtonData(
                ...
                "Auto Tag Placement",
                assemblyPath,
                "ADSK.JExtRAC.AutoLayoutTag.Commands.CmdCreateAutoLayoutTag");
            btnData.LargeImage = LoadPng("IDI_BTN_AUTOMATIC_TAG_L.png", 32);
            btnData.Image = LoadPng("IDI_BTN_AUTOMATIC_TAG_S.png", 16);
