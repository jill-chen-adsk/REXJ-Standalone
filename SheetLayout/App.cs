...
using ADSK.ViewExtension.SheetLayout.Utils;
    ...
    public class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            var btnData = new PushButtonData(
                ...
                "Auto Sheet Layout",
                assemblyPath,
                "ADSK.ViewExtension.SheetLayout.Commands.CmdSheetLayout");
            btnData.LargeImage = LoadPng("IDI_BTN_SHEETLAYOUT_L.png", 32);
            btnData.Image = LoadPng("IDI_BTN_SHEETLAYOUT_S.png", 16);
