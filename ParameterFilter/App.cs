...
namespace ADSK.JExtRAC.ParameterFilter
{
    public class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            var btnData = new PushButtonData(
                ...
                "Parameter Filter",
                assemblyPath,
                "ADSK.JExtRAC.ParameterFilter.Commands.CmdParameterFilter");
            btnData.LargeImage = LoadPng("IDI_BTN_PARAMETER_FILTER_L.png", 32);
            btnData.Image = LoadPng("IDI_BTN_PARAMETER_FILTER_S.png", 16);
